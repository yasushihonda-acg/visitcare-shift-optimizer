...
**最終更新**: 2026-03-09（使い方ガイドページ追加 PR #203 + ヘルプ/Header テスト追加 commit 344c739 マージ済み、CI SUCCESS）
...
- **Optimizer**: 297件 pass ✅
- **Web (Next.js)**: 532件以上 pass ✅（PR #202で+3件、commit 344c739でさらに追加）
- **Firestore Rules**: 107件 pass
- **E2E Tests (Playwright)**: **73テスト以上** pass（PR #200で+3件追加）✅
- **CI/CD**: commit 344c739 main push CI SUCCESS（全ジョブ GREEN + デプロイ完了）
